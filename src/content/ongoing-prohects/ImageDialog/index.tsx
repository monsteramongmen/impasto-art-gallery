  ...
  return (
    ...
    >
      <TopWrapper>
        ...
        {/* images */}
        <Box sx={{ overflow: "scroll", width: "100%", height: "100%", marginTop: "10px", marginBottom: "5px", display: "flex", flexWrap: "wrap", justifyContent: "flex-start", rowGap: "10px", columnGap: "20px" }}>
